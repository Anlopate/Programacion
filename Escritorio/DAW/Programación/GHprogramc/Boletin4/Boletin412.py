...
precio_uva = int(input ("¿Cuál es el precio de la uva?"))
venta = int(input(("¿Cuántas uvas vende?")))
tipo = input ("¿Qué tipo de uva es?")
tamaño = int(input("¿Qué tamaño tiene?"))


if tipo == "a" and tamaño == 1:
    print(f"La ganancia obtenida es {(precio_uva+20)*venta/100} euros")
elif tipo == "a" and tamaño == 2:
    print(f"La ganancia obtenida es {(precio_uva+30)*venta/100} euros ")
    
elif tipo == "b" and tamaño == 1:
    print(f"La ganancia obtenida es {(precio_uva-30)*venta/100} euros ")
elif tipo == "b" and tamaño == 2:
    print(f"La ganancia obtenida es {(precio_uva+-50)*venta/100} euros")  
